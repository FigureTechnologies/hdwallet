...
class TestBIP32 {
    ...
    private data class Tv(val path: String, val xpub: String, val xprv: String)

    private fun runTestVectors(seedHex: String, vectors: List<Tv>) {
        for (vector in vectors) {
            ...
            // seed -> extKey -> bip32
            val derivedXPub = key.serialize(true)
            val derivedXPrv = key.serialize()

            val decodedXPub = vector.xpub.base58DecodeChecked()
            val decodedXPrv = vector.xprv.base58DecodeChecked()
    ...
    @Test
    fun testVector1() = runTestVectors(
    ...
    @Test
    fun testVector2() = runTestVectors(
    ...
    @Test
    fun testVector3() = runTestVectors(
